...
exports.auth = function(name, pass, securityToken, callback) {
	...
	request(options, function (error, res, body) {
    	...
    	if (res.statusCode == 200) {
    		...
    		console.log("failed to authenticate with salesforce")
    		callback(new Error('failed to authenticate. status code: ' + res.statusCode));
    		return;
    	}
    });
}
...
exports.createCase = function(subject, description, callback) {
	...
	request(options, function (error, res, body) {
    	...
    	if (res.statusCode == 201) {
			...
			console.log("view cases @: " + session.instanceUrl + "/apex/CasePage");
